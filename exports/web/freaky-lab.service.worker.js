...
/** @type {string} */
const CACHE_VERSION = '1756454044|1663235785';
/** @type {string} */
const CACHE_PREFIX = 'freaky-lab-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'freaky-lab.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["freaky-lab.html","freaky-lab.js","freaky-lab.offline.html","freaky-lab.icon.png","freaky-lab.apple-touch-icon.png","freaky-lab.audio.worklet.js","freaky-lab.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["freaky-lab.wasm","freaky-lab.pck"];
